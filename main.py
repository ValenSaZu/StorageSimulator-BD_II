...
def create_table_interface(hdd, admin_tablas):
    ...
    decimal_precision_box = InputBox(WIDTH // 2 - 150 + offset_x, HEIGHT // 2 + 10 + offset_y, 120, 40)
    ...
    while True:
                ...
                if finalize_button.collidepoint(event.pos):
                    ...
                    if table_name and column_list:
                        ...
                        for column in column_list:
                            if column[1] == "decimal" and len(column) == 4:
                                new_table.agregar_columna(column[0], column[1], column[2], column[3])
                            elif column[1] == "varchar" and len(column) == 3:
                                new_table.agregar_columna(column[0], column[1], column[2])
                            else:
                                new_table.agregar_columna(column[0], column[1])
        ...
        for column in column_list:
            if column[1] == "decimal" and len(column) == 4:
                draw_label(
                    screen,
                    f"{column[0]} ({column[1]}[{column[2]},{column[3]}])",
                    WIDTH // 2 - 300 + offset_x,
                    y_offset,
                )
            elif column[1] == "varchar" and len(column) == 3:
                draw_label(
